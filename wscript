...
def build(bld):
    ...
    bld.stlib(source=bld.path.ant_glob([#'libppaxos/king.cpp', 'libppaxos/commo2.cpp',
                                        'libppaxos/view.cpp', 'libppaxos/proposer.cpp', 'libppaxos/acceptor.cpp', 
                                        'libppaxos/captain.cpp', 'libppaxos/commo.cpp', 'libppaxos/*.proto',
                                        'libzfec/fec.cc']), 
              target="ppaxos",
    ...
    bld.install_files('${PREFIX}/include', 
                      bld.path.ant_glob('include/ppaxos/*.hpp'))

    bld(features='subst', source='ppaxos.pc.in', 
        target = 'ppaxos.pc', encoding = 'utf8', 
